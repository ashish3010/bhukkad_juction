    ...
    <div className="pb-10">
      ...
      <div className="px-4 pt-5">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-[var(--bj-gold)]">My Orders</h1>
        </div>
        <p className="mt-1 text-sm text-stone-600 dark:text-zinc-400">Up to your last 20 orders on this device.</p>
      </div>

      <div className="mt-6 space-y-3 px-4">
        {orders.length === 0 ? (
          <div className={`${card} py-10 text-center`}>
            <p className="text-sm font-medium text-stone-700 dark:text-zinc-300">No orders yet</p>
            <p className="mt-1 text-xs text-stone-500 dark:text-zinc-500">Place an order from the menu — it will show up here.</p>
            <Link
              href="/home"
          ...
          <>
            <h2 className="text-xs font-bold uppercase tracking-wide text-stone-500 dark:text-zinc-500">Order history</h2>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <span className="shrink-0 text-xs font-semibold text-emerald-600 dark:text-emerald-400">Delivered</span>
                          </div>
